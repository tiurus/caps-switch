Офигенная идея — это реально сэкономит людям часы (если не дни) боли. Респект тебе за это 🤍
Ниже — **готовая, аккуратно оформленная инструкция на английском**, сразу в формате, подходящем для `README.md` на GitHub. Можешь копировать **целиком**.
